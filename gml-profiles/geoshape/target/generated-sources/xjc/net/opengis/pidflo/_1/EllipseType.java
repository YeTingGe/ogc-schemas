...
/**
 * <p>EllipseType complex type的 Java 类。
 * 
    ...
    implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public EllipseType withPos(DirectPositionType value) {
        setPos(value);
        return this;
    }

    public EllipseType withPointProperty(PointPropertyType value) {
        setPointProperty(value);
        return this;
    }

    public EllipseType withSemiMajorAxis(LengthType value) {
        setSemiMajorAxis(value);
        return this;
    }

    public EllipseType withSemiMinorAxis(LengthType value) {
        setSemiMinorAxis(value);
        return this;
    }

    public EllipseType withOrientation(AngleType value) {
